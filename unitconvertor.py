...
st.markdown(
    ...
    .stApp {
        background: linear-gradient(135deg, #2ded, #cfe2f3);
        padding: 30px;
        border-radius: 15px;
    ...
    .stButton>button{
        background: linear-gradient(45deg, #d35400, #351c75);
        color: white;
        font-size: 18px;
        padding: 10px 20px;
        border-radius: 10px;
...
st.markdown("<div class='footer'>Created by Maheen Zehra </div>", unsafe_allow_html=True)
